...
def generate_csvs():
    ...
    for level in LEVELS:
        for split in SPLITS:
            ...
            SAVE_DIR = os.path.join(DATA, 'hf_data', level)
...
if __name__ == '__main__':
    ...
    # # Check csvs
    # df1 = pd.read_csv('data/hf_data/easy/train.csv')
    # df2 = pd.read_csv('data/hf_data/easy/test.csv')
    # df3 = pd.read_csv('data/hf_data/easy/validation.csv')
    # #16142, 5406, 5358
